...
<body>
  ...
  <main id="main">
        ...
        <div class="row gy-4">
          ...
          <div class="col-12 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="border shadow p-3 mb-5 bg-body rounded">
              ...
              <h3><a href="service-details.html" class="stretched-link"><%=itemTitle%></a></h3>
              <p><%=itemBody%></p>
            </div>
          </div><!-- End Card Item -->
          <%
    ...
    <!-- Technology Section -->
    <section style="background-color: #F1F6FF">
        <div class="container" >
          <div class="row gy-4">
            <%
                set rsArticle = CreateObject("ADODB.recordset")
    ...
    <section style="background-color: #FFFFFF">
      <div class="container">
            ...
            <div class="row">
                ...
                %>
                    ...
                    <div class="row " style="align-items: center;">
                        <div class="col-6">
                            <h6 class="text-uppercase"><%=itemTitle%></h6>
                            <p></p>
                        </div>
                    </div>
                </div>
                <%
                  ...
                  <div class="col-md-6 col-12">
                    <div class="row d-flex justify-content-center" style="align-items: center;">
                      <div>
                        <div class="col-6 p-0">
                            <img src="<%=pictureUrl%>"alt="<%=itemTitle%>">
                        </div>
                        <div class="col-6">
                            <h6 class="text-uppercase"><%=itemTitle%></h6>
                            <p></p>
        ...
        <div class="button-center py-5">
            <a class="bg-bluegt btnn text-white" href="">Khám phá</a>
        </div>  
    </div>
    </section>
