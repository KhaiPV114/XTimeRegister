  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div>
            <h3>Đăng kí sử dụng phần mềm</h3>
        </div>
        ...
        <div class="row gy-4 mt-4">
            ...
            <div id="services_body">
                <div id="show_price">
                    <h2 class="title-packet">XTIME GOLD - 1 NĂM</h2>
                    <div class="packet-box-price"> 
                        <h2 class="packet-price">3,000,000&nbsp;VNĐ       </h2>
                                                
                    </div> 
                </div><!----/.show_price---> 
                    <div><span style="font-size:16px">Dễ dàng kiểm soát thời gian – Quản lý tối đa hiệu quả công việc.<br>
                    Theo dõi được thời gian làm việc và thời gian chấm công của nhân viên trực tiếp trên app điện thoại. Luôn quản lý được KPI cần làm, cần ưu tiên và dateline công việc.</span></div>
